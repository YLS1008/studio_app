...
class TraineesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainee" do
    assert_difference('Trainee.count') do
      post trainees_url, params: { trainee: { email: @trainee.email, first: @trainee.first, last: @trainee.last, phone: @trainee.phone } }
    end
  ...
  test "should update trainee" do
    patch trainee_url(@trainee), params: { trainee: { email: @trainee.email, first: @trainee.first, last: @trainee.last, phone: @trainee.phone } }
