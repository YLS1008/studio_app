...
class ContactsTest < ApplicationSystemTestCase
  ...
  test "creating a Contact" do
    ...
    fill_in "First", with: @contact.first
    fill_in "Interests", with: @contact.interests
    fill_in "Last", with: @contact.last
    fill_in "Phone", with: @contact.phone
    fill_in "Type of contact", with: @contact.type_of_contact
